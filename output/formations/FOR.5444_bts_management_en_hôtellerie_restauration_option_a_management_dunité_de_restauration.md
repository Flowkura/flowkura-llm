...
**Code scolarité:** 32033423
**Sigle:** MHR
**Durée:** 2 ans
**Niveau de certification:** niveau 5
**Type:** brevet de technicien supérieur (BTS)

**Lien:** [https://enqdip.sup.adc.education.fr/bts/referentiel/BTS_Management_hotellerie_restauration.PDF](https://enqdip.sup.adc.education.fr/bts/referentiel/BTS_Management_hotellerie_restauration.PDF)

## Description

Le BTS management en hôtellerie-restauration se décline en trois options préparant chacune à des métiers spécifiques.

            Commune à l'ensemble des élèves, la 1re année se concentre sur les fondamentaux en cuisine, en service et en hébergement. Objectif : acquérir des compétences polyvalentes. Une partie importante est consacrée aux règles d'hygiène et de conservation des aliments, à la gestion des stocks, aux techniques culinaires fondamentales, à l'accueil et au service des clients. Des enseignements généraux appliqués à l'hôtellerie-restauration sont également prévus : des notions de ressources humaines, de droit et de comptabilité sont intégrées dans un cours sur l'entrepreneuriat et le pilotage de l'entreprise hôtelière. L'adaptation aux nouveaux modes de consommation des clients et à la digitalisation est abordée en management et marketing, tout comme la gestion d'une équipe. Enfin, deux langues étrangères, dont l'anglais, figurent au programme. 

            L'option management d'unité de restauration met l'accent sur les savoir-faire techniques du service en restaurant : dresser une table, présenter un menu, valoriser des produits, gérer les stocks de boissons, ou encore encadrer une équipe. L'apprentissage de la sommellerie et des techniques de bar est renforcé avec des cours sur la gestion d'une cave à vins et le service des alcools et cocktails.

## Accès

### Accès
            Le BTS MHR (management en hôtellerie-restauration) est accessible avec un bac technologique STHR (sciences et technologies de l'hôtellerie et de la restauration), mais aussi un bac pro commercialisation et services en restauration ou un bac pro cuisine. Pour les autres types de bacs, le passage par une année de mise à niveau est obligatoire. Accès sur dossier, voire tests et/ou entretien.
