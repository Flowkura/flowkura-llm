# DEJEPS spécialité perfectionnement sportif mention sports de glace option B : disciplines de vitesse sur glace (courte piste et longue piste)
...
**Lien:** [https://www.francecompetences.fr/recherche/rncp/36824/](https://www.francecompetences.fr/recherche/rncp/36824/)

## Description

Le titulaire du DEJEPS perfectionnement sportif mentions sports de glace option B apprend à :

            -  concevoir un projet d'action (UC1) en élaborant un programme d'entraînements sportifs prenant en compte les caractéristiques physiques, motrices, sensorielles, cognitives et psychiques des différents publics, notamment ceux en situation de handicap.

             - coordonner un projet d'action (UC2) en animant une équipe de professionnels et de bénévoles autour d'un projet donné,

            -  proposer un programme de perfectionnement sportif (UC3) prenant en compte les particularités physiques et motrices des pratiquants mais aussi leur objectif personnel,

            - encadrer en sécurité (UC4), en effectuant des démonstrations techniques sans se blesser, ni blesser les pratiquants.
